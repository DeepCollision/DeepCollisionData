...
More details of Hyper-parameters of DQN used in DeepCollision can be accessed here [Hyperparameter](https://github.com/DeepCollision/DeepCollisionData/blob/main/Hyper-parameters.md).
